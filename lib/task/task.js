...
export { Task };
export var task = function (fork) { return new Task(fork); };
export var taskFromPromise = function (promise) { return task(function (reject, resolve) { return promise.then(resolve, reject); }); };
export var rejected = function (failure) { return new Task(function (reject, _) { return reject(failure); }); };
export var resolved = function (success) { return new Task(function (_, resolve) { return resolve(success); }); };
