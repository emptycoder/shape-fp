"use strict";
var run_parallel_1 = require("run-parallel");
var Task = (function () {
    function Task(fork) {
        this._fork = fork;
    }
    ...
    Task.prototype.parallel = function (f) {
        var previousFork = this._fork;
        return new Task(function (reject, resolve) {
            return previousFork(function (failure) { return reject(failure); }, function (success) { return run_parallel_1.default(f(success), function (err, results) {
                if (err) {
                    reject(err);
                }
                else {
